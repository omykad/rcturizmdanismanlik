...
<html lang="en">
   <head>
      ...
      <link rel="icon" type="image/png" href="/img/rc400.png" sizes="32x32">
      <link rel="apple-touch-icon" type="image/png" href="/img/rc400.png" sizes="32x32">
      ...
      <link href="/js/remixicon/remixicon.css" rel="stylesheet">
            ...
            <div class="container">
               ...
               <div class="row justify-content-center" >
                  <div class="col-lg-2 col-md-4 col-12 p-3 pb-sm-0">
                     <img src="/img/sheraton-gold.png" class="img-fluid" alt="Sheraton Hotel" data-aos="zoom-in">
                  </div>
                  <div class="col-lg-2 col-md-4 col-12 p-3 pb-sm-0">
                  ...
                  <div class="col-lg-2 col-md-4 col-12 p-0 pb-sm-0">
                     <img src="/img/kaya2.png" class="img-fluid" alt="Kaya Otel" style="transform: scale(2);" data-aos="zoom-in" data-aos-delay="300">
                  </div>
                  <div class="col-lg-2 col-md-4 col-12 p-3 pb-sm-0">
                     <img src="/img/etap.png" class="img-fluid" alt="Etap Hotel" style="transform: scale(0.9);"  width="0.5em" data-aos="zoom-in" data-aos-delay="400">
                  </div>
                  <div class="col-lg-2 col-md-4 col-12 p-3 pb-sm-0">
                     <img src="/img/grandankara.svg" class="img-fluid" style="transform: scale(1.6);" alt="Grand Ankara Hotel" data-aos="zoom-in" data-aos-delay="500">
                  </div>
               </div>
            </div>
         </section>
               ...
               <div class="row" data-aos="fade-up" data-aos-delay="300">
                  <div class="col-lg-3 col-md-4 mt-4 position-relative px-1">
                     <div class="icon-box" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                        ...
                        <i class="dropdown-toggle fs-6 position-absolute" style="right:5px;color: #333;"></i>
                     </div>
                  ...
                  <div class="col-lg-3 col-md-4 mt-4 position-relative px-1">
                     ...
                     <div class="collapse" id="collapseExample6">
                        <div class="card card-body border-0">
                           Her işletmenin özel durumlarına göre standartları belirlemek ve buna bağlı kalite arttırma çalışmaları yapmak.                      
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-3 col-md-4 mt-4 position-relative px-1">
                  ...
                  <div class="col-lg-3 col-md-4 mt-4 position-relative px-1">
                     <div class="icon-box" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample15" aria-expanded="false" aria-controls="collapseExample15">
            ...
            <div class="container">
               ...
               <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                  <div class="col-lg-5">
                     ...
                     <h4><b>Yatırımlarımız ne kadar sürede geri döner?</b></h4>
                  </div>
                  <div class="col-lg-7">
                     <p>
                        Proje, yatırım, piyasa ve rekabet parametreleri göz önüne alınarak genellikle 3 yıl ve üzeri sürede geri dönmesi beklenmektedir. 
                     </p>
                  </div>
               </div>
               <!-- End F.A.Q Item-->
               <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
                  ...
                  <div class="col-lg-7">
                     <p>
                        Evet! Faaliyetteki işletmelerde yaşanan veya beklenen ciroların düşük olmasından kaynaklı tüm isteklerinize çözüm ortağıyız. 
                     </p>
                  </div>
               </div>
               <!-- End F.A.Q Item-->
               <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
                  <div class="col-lg-5">
                     <i class="ri-question-line"></i>
                     <h4><b>İşletmeye desteğiniz ne kadar sürüyor?</b></h4>
                  </div>
                  <div class="col-lg-7">
                     <p>
                        Proje işletmelerde faaliyete başladıktan sonra 1 yıl süre içinde rutin kontrollerimiz devam ediyor. 
                     </p>
                  </div>
               </div>
               <!-- End F.A.Q Item-->
